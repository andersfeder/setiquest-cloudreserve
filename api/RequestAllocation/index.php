...
$query = sprintf("INSERT INTO cr_requests (request_id,nonce,owner,title,description,imageid,instancetype,mincount,maxcount,begins,duration,includes) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s',%s,'%s','%s')",
    $id,
